...
class MongoDBFormatter implements \CPWFreeVendor\Monolog\Formatter\FormatterInterface
{
    ...
    {
        $formattedException = ['class' => \CPWFreeVendor\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
