...
class LineFormatter extends \CPWFreeVendor\Monolog\Formatter\NormalizerFormatter
{
    ...
    public function format(array $record) : string
    {
        ...
        if (\false !== \strpos($output, '%')) {
            ...
            if (null === $output) {
                ...
                throw new \RuntimeException('Failed to run preg_replace: ' . $pcreErrorCode . ' / ' . \CPWFreeVendor\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
            }
        }
        return $output;
    }
    ...
    {
        $str = '[object] (' . \CPWFreeVendor\Monolog\Utils::getClass($e) . '(code: ' . $e->getCode();
