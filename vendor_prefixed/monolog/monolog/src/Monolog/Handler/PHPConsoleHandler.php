...
class PHPConsoleHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(array $options = [], ?\CPWFreeVendor\PhpConsole\Connector $connector = null, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    private function initConnector(?\CPWFreeVendor\PhpConsole\Connector $connector = null) : \CPWFreeVendor\PhpConsole\Connector
    {
        if (!$connector) {
    ...
    public function getConnector() : \CPWFreeVendor\PhpConsole\Connector
    {
