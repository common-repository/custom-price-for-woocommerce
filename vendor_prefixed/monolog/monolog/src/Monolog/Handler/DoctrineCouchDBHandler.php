 ...
 */
class DoctrineCouchDBHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /** @var CouchDBClient */
    private $client;
    public function __construct(\CPWFreeVendor\Doctrine\CouchDB\CouchDBClient $client, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
        $this->client = $client;
