...
class CubeHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(string $url, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    protected function connectHttp() : void
    {
        if (!\extension_loaded('curl')) {
            throw new \CPWFreeVendor\Monolog\Handler\MissingExtensionException('The curl extension is required to use http URLs with the CubeHandler');
        }
