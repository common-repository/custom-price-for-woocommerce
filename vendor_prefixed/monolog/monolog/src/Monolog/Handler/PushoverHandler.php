...
class PushoverHandler extends \CPWFreeVendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \CPWFreeVendor\Monolog\Logger::CRITICAL, bool $bubble = \true, bool $useSSL = \true, $highPriorityLevel = \CPWFreeVendor\Monolog\Logger::CRITICAL, $emergencyLevel = \CPWFreeVendor\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200, bool $persistent = \false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = null, ?int $chunkSize = null)
    {
    ...
    private function buildContent(array $record) : string
    {
        ...
        $message = \CPWFreeVendor\Monolog\Utils::substr($message, 0, $maxMessageLength);
    ...
    {
        $this->highPriorityLevel = \CPWFreeVendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
     * @param int|string $value
    ...
    {
        $this->emergencyLevel = \CPWFreeVendor\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
