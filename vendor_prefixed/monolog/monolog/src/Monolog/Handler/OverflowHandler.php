 ...
 */
class OverflowHandler extends \CPWFreeVendor\Monolog\Handler\AbstractHandler implements \CPWFreeVendor\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\CPWFreeVendor\Monolog\Logger::DEBUG => 0, \CPWFreeVendor\Monolog\Logger::INFO => 0, \CPWFreeVendor\Monolog\Logger::NOTICE => 0, \CPWFreeVendor\Monolog\Logger::WARNING => 0, \CPWFreeVendor\Monolog\Logger::ERROR => 0, \CPWFreeVendor\Monolog\Logger::CRITICAL => 0, \CPWFreeVendor\Monolog\Logger::ALERT => 0, \CPWFreeVendor\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\CPWFreeVendor\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
