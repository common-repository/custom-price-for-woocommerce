...
class ErrorLogHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(int $messageType = self::OPERATING_SYSTEM, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true, bool $expandNewlines = \false)
    {
    ...
    protected function write(array $record) : void
    {
        ...
        if ($lines === \false) {
            ...
            throw new \RuntimeException('Failed to preg_split formatted string: ' . $pcreErrorCode . ' / ' . \CPWFreeVendor\Monolog\Utils::pcreLastErrorMessage($pcreErrorCode));
        }
