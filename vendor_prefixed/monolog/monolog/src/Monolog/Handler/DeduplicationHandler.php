...
class DeduplicationHandler extends \CPWFreeVendor\Monolog\Handler\BufferHandler
{
     ...
     */
    public function __construct(\CPWFreeVendor\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \CPWFreeVendor\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
