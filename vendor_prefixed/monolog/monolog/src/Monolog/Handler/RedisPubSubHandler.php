 ...
 */
class RedisPubSubHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
