...
class FlowdockHandler extends \CPWFreeVendor\Monolog\Handler\SocketHandler
{
     ...
     */
    public function __construct(string $apiToken, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true, bool $persistent = \false, float $timeout = 0.0, float $writingTimeout = 10.0, ?float $connectionTimeout = null, ?int $chunkSize = null)
    {
