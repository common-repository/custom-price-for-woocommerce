 ...
 */
class ProcessHandler extends \CPWFreeVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct(string $command, $level = \CPWFreeVendor\Monolog\Logger::DEBUG, bool $bubble = \true, ?string $cwd = null)
    {
        if ($command === '') {
