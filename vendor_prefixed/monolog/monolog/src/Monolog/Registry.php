...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\CPWFreeVendor\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
     ...
     */
    public static function getInstance($name) : \CPWFreeVendor\Monolog\Logger
    {
