 ...
 */
class SimplePhpRenderer implements \CPWFreeVendor\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\CPWFreeVendor\WPDesk\View\Resolver\Resolver $resolver)
    {
