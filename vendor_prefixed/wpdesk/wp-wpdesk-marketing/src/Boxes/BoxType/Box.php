 ...
 */
class Box implements \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\Abstracts\BoxInterface
{
    const TYPE = 'simple';
    /**
     * @var array{
     ...
     * @param array    $box
     */
    public function __construct(array $box, \CPWFreeVendor\WPDesk\View\Renderer\Renderer $renderer)
    {
        $this->box = $box;
