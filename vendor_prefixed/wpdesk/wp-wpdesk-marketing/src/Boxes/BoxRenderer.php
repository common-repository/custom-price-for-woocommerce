...
class BoxRenderer
{
    ...
    public function __construct(array $boxes, \CPWFreeVendor\WPDesk\View\Renderer\Renderer $renderer = null)
    {
        $this->boxes = $boxes;
        ...
        $this->bbcodes = new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\Helpers\BBCodes();
        $this->markers = new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\Helpers\Markers();
    }
     ...
     */
    public function get_box_type(array $box) : \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\Abstracts\BoxInterface
    {
        switch ($box['type']) {
            case 'slider':
                return new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\BoxType\SliderBox($box, $this->renderer);
            case 'image':
                return new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\BoxType\ImageBox($box, $this->renderer);
            case 'video':
                return new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\BoxType\VideoBox($box, $this->renderer);
            case 'simple':
                return new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\BoxType\SimpleBox($box, $this->renderer);
            default:
                return new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\BoxType\UnknownBox($box, $this->renderer);
        }
    }
}
