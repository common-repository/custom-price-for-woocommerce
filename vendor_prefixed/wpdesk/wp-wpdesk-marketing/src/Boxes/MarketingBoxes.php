...
class MarketingBoxes
{
    ...
    {
        return \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\Helpers\Cache::create_slug($this->plugin_slug, $this->lang);
    }
    /**
     * @return BoxRenderer
     * @throws \Exception
     */
    public function get_boxes() : \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\BoxRenderer
    {
        try {
        ...
        return new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\BoxRenderer($boxes);
    }
    /**
     * @return array
     */
    ...
    {
        $lang = $this->lang;
        $client = new \CPWFreeVendor\WPDesk\Library\Marketing\Boxes\Api\Client($this->plugin_slug);
