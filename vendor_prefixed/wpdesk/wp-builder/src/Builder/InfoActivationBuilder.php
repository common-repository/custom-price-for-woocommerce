 ...
 */
class InfoActivationBuilder extends \CPWFreeVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \CPWFreeVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\CPWFreeVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
